    ...
    <div className="pb-20">
      ...
      <section className="section">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-6">
            <Badge>{levelTranslation[course.level]}</Badge>
            ...
            <div className="flex gap-4">
              <Button href={`/courses/${course.slug}/buy`} size="lg" className="glow">
                Купить курс
              </Button>
      ...
      <section className="section-tight">
        <SectionHeading
          ...
          description="Всё необходимое для успешного освоения материала и применения знаний на практике"
        />
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {course.whatIncluded.map((item, index) => (
            <Card key={index} className="p-6 neon-border">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[color:var(--neon)]/20 text-[color:var(--neon)]">
      ...
      <section className="section">
        <SectionHeading
          ...
          description="Каждый модуль построен вокруг практических задач с пошаговым разбором"
        />
      ...
      <section className="section-tight">
        <SectionHeading
          ...
          description="Истории успеха выпускников, которые уже прошли курс"
        />
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {[
            { quote: '«Я автоматизировал три воркфлоу за две недели.»', author: 'Алексей, Product Manager' },
            { quote: '«Плейбуки сократили время выхода на рынок вдвое.»', author: 'Мария, Founder' },
            { quote: '«Лучшая ИИ-программа, которую я проходил в этом году.»', author: 'Дмитрий, Tech Lead' }
        ...
        <Card className="flex flex-col items-start gap-6 p-8 md:flex-row md:items-center md:justify-between neon-border glow">
          <div>
            ...
            <p className="mt-2 text-sm text-[color:var(--muted)]">
              Следующий старт: 7 апреля 2026
            </p>
          </div>
          <div className="flex gap-4">
            <Button href={`/courses/${course.slug}/buy`} size="lg">
              Забронировать место
            </Button>
